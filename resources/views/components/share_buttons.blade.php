<iframe
 ...
 <iframe
    src="https://platform.twitter.com/widgets/tweet_button.html?url={{ secure_url('') }}&via={{ config('participa.twitter', 'infoDisedit') }}&related={{ config('participa.twitter', 'infoDisedit') }}&text={{ urlencode($slot) }}&lang=@lang('participa.twitter_locale')"
    class="twitter"
    width="120"
    height="20"
    allowTransparency="true"
