            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ secure_url('/login') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon" id="user-icon"><i class="far fa-user" aria-hidden="true"></i></span>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon" id="key-icon"><i class="far fa-lock" aria-hidden="true"></i></span>
